...
const NoticeDetail = () => {
    ...
    return (
        <section className="max-w-[800px] w-[95%] mx-auto py-8">
            <Helmet>
                <title>{notice ? notice.title : "নোটিশ বিস্তারিত"}</title>
            </Helmet>
            <h1 className="text-2xl font-bold text-center">অত্র জামিয়ার বিস্তারিত নোটিশ</h1>
            <br />
                    ...
                    {notice ? (
                        <div className="p-14 border rounded-lg shadow-2xl">
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                                🗓️ প্রকাশের তারিখ: {new Date(notice.created_at).toLocaleDateString("bn-BD")}
                            </p>
                            <p className="text-sm text-gray-500 mt-2">
                                🗓️ আপডেটের তারিখ: {new Date(notice.updated_at).toLocaleDateString("bn-BD")}
                            </p>
                            <p className="mt-4">{notice.description || "এই নোটিশের বিস্তারিত তথ্য নেই।"}</p>
                            <br />
